...
setup(
    ...
    scripts=['e3sm_to_cmip/scripts/check_input_dataset.py',
             'e3sm_to_cmip/scripts/cmor-example.py',
             'e3sm_to_cmip/scripts/convert_land_variables.py',
             'e3sm_to_cmip/scripts/data_stager.py',
             'e3sm_to_cmip/scripts/esgf_check.py',
             'e3sm_to_cmip/scripts/find_sftlf_issue.py',
             'e3sm_to_cmip/scripts/fix_mask.py',
             'e3sm_to_cmip/scripts/fix_msftmz.py',
             'e3sm_to_cmip/scripts/fix_time.py',
             'e3sm_to_cmip/scripts/generate_xmls_cmip6.py',
             'e3sm_to_cmip/scripts/hash_dataset.py',
             'e3sm_to_cmip/scripts/join_output.py',
             'e3sm_to_cmip/scripts/output_checker.py',
             'e3sm_to_cmip/scripts/run_regrid.py',
             'e3sm_to_cmip/scripts/setup_cases.py',
             'e3sm_to_cmip/scripts/tar_to_bagit.py'],
